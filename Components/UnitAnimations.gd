class_name UnitAnimations extends Node


const COMBINE_ANIM_LENGTH: float = 0.6
const COMBINE_ANIM_SCALE: Vector2 = Vector2(0.7, 0.7)
const COMBINE_ANIM_ALPHA: float = 0.5
